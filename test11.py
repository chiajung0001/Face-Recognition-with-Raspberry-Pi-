...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        try:
           ...
           if save_n == -1:  # 如果架上重為零時
              save_n = tf  # 架上重就等於測重

           elif save_n > tf:  # 如果架上重大於測重
              save_n = tf  # 架上重就等於測重

           elif save_n < tf:  # 如果架上重小於測重
              save_n = tf
              ...
              if len(matches)>0:
                 ...
                 p.produce('shelf', value=member_detail_json)
              else:
                 name = "Unknown"
